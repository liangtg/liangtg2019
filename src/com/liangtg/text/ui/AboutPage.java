...
public class AboutPage extends BackPage {
	private String license = "<html><h2>H2 Database Engine</h2>H2 is dual licensed and available under the MPL 2.0 (Mozilla Public License Version 2.0) or under the EPL 1.0 (Eclipse Public License). There is a license FAQ for both the MPL and the EPL.\n"
